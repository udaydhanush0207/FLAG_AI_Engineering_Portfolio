...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Projects-8_AI_Tools-062052?style=for-the-badge" alt="Projects">
...
Eight AI-powered tools built for **Front Line Advisory Group (FLAG)**, a capital improvement consulting firm managing **$6.5B+ in public infrastructure programs** across Texas and New York.
...
|---|---------|-------------|------|--------|
| 1 | [**BRICK Knowledge Bot**](./01_BRICK_Knowledge_Bot) | RAG-powered knowledge bot that answers questions about FLAG's CIP programs, bond management, 200+ acronyms, and project status | FastAPI, ChromaDB, OpenAI, OpenClaw | 🔨 Building |
...
| 7 | [**Lead Gen & Verified Email Agent**](./07_Lead_Gen_Email_Agent) | Scrapes county gov sites and TX procurement portals for BD contacts, verifies emails before CRM entry — zero manual prospecting | Python, Playwright, SMTP, FastAPI, OpenClaw | 🔨 Building |
| 8 | [**Content & Campaign Agent**](./08_Content_Campaign_Agent) | Turns FLAG blog posts into LinkedIn drafts, carousel copy, and email snippets — delivered to Roy/Jessy via Telegram for approval | OpenAI, BeautifulSoup, FastAPI, OpenClaw | 📋 Planned |

---

## 🏛️ Architecture

All eight projects share **one server** and **one OpenClaw instance**. Each project is an OpenClaw "skill" that can be triggered via Telegram, web interface, or scheduled automation.
```
┌──────────────────────────────────────────────────┐
│                 VPS ($4-6/month)                  │
│                                                   │
...
│     v             v                  v            │
│  ┌──────────┐  ┌──────────────────────────────┐  │
│  │ Lead Gen │  │  Content & Campaign Agent     │  │
│  │  Agent   │  │  (LinkedIn + Email Drafts)    │  │
│  └──────────┘  └──────────────────────────────┘  │
│                                                   │
│  ┌─────────────────────────────────────────────┐  │
...
| **Scraping** | Playwright, BeautifulSoup | Lead gen + content ingestion |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-062052?style=flat-square&logo=linkedin)](https://www.linkedin.com/in/venkatsatyaudaydhanushkarri/)
